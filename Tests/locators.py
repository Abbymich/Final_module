class RTAutorizationLocators():
    ...
    LOCATOR_RT_AUTORIZATION_BUTTON_VK = "oidc_vk"
    LOCATOR_RT_AUTORIZATION_BUTTON_OK = "oidc_ok"
    LOCATOR_RT_AUTORIZATION_BUTTON_MAIL = "oidc_mail"
    LOCATOR_RT_AUTORIZATION_BUTTON_YA = "oidc_ya"
    LOCATOR_RT_USER_AGREEMENT = "rt-link rt-link--orange"


class RTRegistrationLocators:
    LOCATOR_RT_REGISTRATION_BUTTON_REGISTER = "//*[@id='kc-register']"
